		...
		while (true) {
			try {
				...
				if (flag % 10 == 0) {
					...
					this.ChunkServerAssociated.connectionToController.sender
					...
					synchronized (ChunkServerAssociated.newlyAddedChunks) {
						ChunkServerAssociated.newlyAddedChunks.clear();
					}
				}
			} catch (Exception e) {
				e.printStackTrace();
